...
def test_locale_language_detection() -> None:
    ...
    with (
        patch("ctypes.windll.kernel32.GetUserDefaultLocaleName", return_value=5),
...
def test_translation_lookups() -> None:
    ...
    mock_lang = {
        "starting": "啟動中...",
        "exit": "退出",
        "autostart_failed_msg": "錯誤: {error}",
    }
    with patch("magical_girl_glow_down.i18n.LANG_DATA", mock_lang):
